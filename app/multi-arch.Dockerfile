...
ENV PYTHONUNBUFFERED=1 MTX_PROTOCOLS=tcp MTX_READTIMEOUT=20s MTX_LOGLEVEL=warn MTX_WEBRTCICEUDPMUXADDRESS=:8189 SDK_KEY=REDACTED_SDK_KEY FLASK_APP=frontend
