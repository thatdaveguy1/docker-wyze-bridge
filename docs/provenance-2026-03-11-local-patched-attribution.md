...
- Regression and investigation files: `test_audio_session_lifetime.py`, `test_connect_watchdog_timeout.py`, `test_fixes.py`, `test_v4_auth_protocol.py`, `test_v4_timeout_fix.py`, `test_before_fix.sh`, `test_after_fix.sh`, `proposedPRs.md`
...
- Planning and handoff docs: `LIVE-DEPLOYMENT.md`, `docs/plans/2026-03-10-ha-preview-stream-fixes.md`, `docs/plans/2026-03-11-on-demand-rtsp-readiness.md`
...
- Additional planning and runbook docs: `docs/plans/2026-03-10-downstream-switchover.md`, `docs/plans/2026-03-10-ha-stream-menu-copy-plan.md`, `docs/runbooks/wyze-scrypted-mqtt-runbook.md`
- This provenance record: `docs/provenance-2026-03-11-local-patched-attribution.md`
