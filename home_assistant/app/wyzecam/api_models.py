...
def v4_kvs_trial_enabled() -> bool:
    return os.getenv("ENABLE_V4_KVS_TRIAL", "").strip().lower() in {
        "1",
        "true",
        "yes",
        "on",
...
def all_rtc_trial_enabled() -> bool:
    return os.getenv("ENABLE_ALL_RTC_TRIAL", "").strip().lower() in {
        "1",
        "true",
        "yes",
        "on",
