...
def should_take_snapshot(snapshot_type: str, last_snap: float) -> bool:
    ...
    try:
        ...
        Exception
    ):  # astral sun calculation can raise ValueError/KeyError on edge-case coordinates; fall back to default interval
        # Log error with traceback
        logger.error("Error calculating sunrise/sunset times:")
