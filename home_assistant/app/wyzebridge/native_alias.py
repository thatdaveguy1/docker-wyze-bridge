"""Native alias readiness, selection, and talkback — extracted from go2rtc.py.

Architecture review candidate #9: one module owns the native alias lifecycle
(ready/cache/probe/snapshot/talkback) behind a narrow seam. go2rtc.py keeps
the core API/probe helpers; this module owns alias-specific logic.
"""
import base64
import os
import re
...
# --- Port helpers (duplicated from go2rtc.py to avoid circular import) ---
